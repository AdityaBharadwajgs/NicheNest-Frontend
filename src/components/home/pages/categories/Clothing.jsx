    ...
    <div className="min-h-screen font-sans bg-white text-gray-800">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 bg-gray-100 rounded-[3rem] shadow-inner border border-gray-200 mt-10">
        ...
        {searchQuery && displayedProducts.length === 0 && (
          <p className="bg-white/50 text-red-500 p-4 rounded-xl border border-red-100 mb-10 text-center font-medium">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {displayedProducts.length === 0 ? (
              <p className="col-span-full text-center text-gray-500 italic py-10 bg-white/30 rounded-2xl border border-white/50">
              ...
              displayedProducts.map((product) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <span className="text-[10px] bg-gray-50 text-gray-400 px-2 py-1 rounded-full border border-gray-100 font-bold uppercase">
                      Stock: {product.stock}
                    </span>
                  </div>
