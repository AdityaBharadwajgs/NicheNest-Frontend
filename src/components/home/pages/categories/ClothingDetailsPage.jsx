...
export default function ClothingDetailsPage() {
  ...
  if (error || !product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-8">
        <h2 className="text-2xl font-bold mb-4 text-red-600">Clothing item not found</h2>
        <Link to="/categories/clothing">
          <Button>← Back to Clothing</Button>
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen max-w-5xl mx-auto px-6 py-12 space-y-10 font-sans">
      <Link to="/categories/clothing">
        <Button className="mb-6">← Back to Clothing</Button>
      </Link>
        ...
        <div className="space-y-4">
          <div className="border-b border-gray-200 pb-4">
            <div className="flex items-center justify-between mb-2">
              <span className="font-medium">Simran P.</span>
              <div className="flex items-center gap-1">{renderStars(5)}</div>
            </div>
            <p className="text-gray-700">The fabric is so soft and the fit is perfect. Loved the traditional touch!</p>
            <p className="text-sm text-gray-500 mt-1">2 days ago</p>
          </div>
          <div className="pb-4">
            <div className="flex items-center justify-between mb-2">
              <span className="font-medium">Amit T.</span>
              <div className="flex items-center gap-1">{renderStars(4)}</div>
            </div>
            <p className="text-gray-700">Great value for money and very comfortable to wear.</p>
